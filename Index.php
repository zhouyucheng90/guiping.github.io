...
a.arrow1 {font-family:Webdings, sans-serif; color:#343525; font-size:10px; }
-->
</style>
</head>
<body>
...
============================================================= -->
		...
		<tr>
		  <td><table width="100%" border="0" cellspacing="1" cellpadding="0" id="t">
		    <tr>
		      ...
		      <td><a href="#bottom" class="arrow1">66</a></td>
	        </tr>
		    <tr>
		      <th colspan="7">服务器正常运行中~！</th>
	        </tr>
	      </table>		    <a href="#sec5"></a></td>
		</tr>
		</table>
	  <!-- =============================================================
伺服器特性 
...
============================================================== -->
		<table width="100%" cellpadding="0" cellspacing="1" border="0" id="m4">
			...
			<tr>
				<td>Tahiti 的電腦(P4 2.6G 4068M WinXP)</td>
				<td> 1.421秒</td>
				<td> 1.358秒</td>
				<td> 0.177秒</td>
			</tr>
			<tr>
				<td>PIPNI空間(2012/06/28 02:08)</td>
				<td> 2.545秒</td>
				<td> 2.545秒</td>
				<td>0.171秒 </td>
			</tr>
			<tr>
				<td>神話科技風CGI型(2012/06/28 02:03)</td>
				<td> 0.797秒</td>
				<td> 0.729秒</td>
				<td>0.156秒</td>
			</tr>
